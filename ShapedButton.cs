...
namespace DropDownControl_CSharp
{
    public class ShapedButton : System.Windows.Forms.Button
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            base.OnResize(e);
            int w = 0;
            textX = (int)((this.Width / 3) - 1) + w;
            textY = (int)((this.Height / 3) + 7);
        }
        ...
        //draw triangular button function
        void DrawTriangularButton(Graphics g)
        {
            Color c1 = Color.FromArgb(color1Transparent, color1);
            Color c2 = Color.FromArgb(color2Transparent, color2);
            ...
            Point[] points = new Point[] {
             new Point(this.Width / 2, 5), 
             new Point(this.Width-10,this.Height-10),
             new Point(5,this.Height-10),
             new Point(this.Width/2,5)
            };

            g.FillPolygon(b, points, FillMode.Winding);

            for (int i = 0; i < borderWidth; i++)
            {
                g.DrawLine(new Pen(buttonborder_1), (this.Width / 2) + i, 5 + i, 5 + i, (this.Height - 10) + i);
                g.DrawLine(new Pen(buttonborder_1), (this.Width / 2) - i, 5 + i, (this.Width - 10) - i, (this.Height - 10) + i);
                g.DrawLine(new Pen(buttonborder_2), 5, this.Height - 10 - i, this.Width - 10, this.Height - 10 - i);
            }
        ...
        //draw diamond button function
        void DrawDiamondButton(Graphics g)
        {
            Color c1 = Color.FromArgb(color1Transparent, color1);
            Color c2 = Color.FromArgb(color2Transparent, color2);
            ...
            for (int i = 0; i < borderWidth; i++)
            {
                g.DrawLine(new Pen(buttonborder_1), (this.Width / 2) + i, 5 + i, 5 + i, (this.Height / 2) + i);
                g.DrawLine(new Pen(buttonborder_1), (this.Width / 2) - i, 5 + i, (this.Width - 10) - i, this.Height / 2 + i);
                g.DrawLine(new Pen(buttonborder_2), this.Width - 10 - i, this.Height / 2 - i, this.Width / 2 - i, this.Height - 10 - i);
                g.DrawLine(new Pen(buttonborder_2), this.Width / 2 + i, this.Height - 10 - i, 5 + i, this.Height / 2 - i);
            }
        ...
        //draw pentagon button function
        void DrawPentagonButton(Graphics g)
        {
            Color c1 = Color.FromArgb(color1Transparent, color1);
            Color c2 = Color.FromArgb(color2Transparent, color2);
            ...
            Point[] points = new Point[] {
             ...
             new Point(this.Width-10,this.Height/2-20),
             new Point(this.Width-30,this.Height-10),
            new Point(40,this.Height-10),
            new Point(20,this.Height/2-20),
            new Point(this.Width/2,2)
            };
            ...
            for (int i = 0; i < borderWidth; i++)
            {
                g.DrawLine(new Pen(buttonborder_2), this.Width / 2 + i, 2, this.Width - 10 + i, this.Height / 2 - 20);
                g.DrawLine(new Pen(buttonborder_2), 20 - i, this.Height / 2 - 20, this.Width / 2 - i, 2);
                g.DrawLine(new Pen(buttonborder_1), this.Width - 10 + i, this.Height / 2 - 20, this.Width - 30 + i, this.Height - 10);
                g.DrawLine(new Pen(buttonborder_1), this.Width - 30, this.Height - 10 + i, 40, this.Height - 10 + i);
                g.DrawLine(new Pen(buttonborder_1), 40 - i, this.Height - 10, 20 - i, this.Height / 2 - 20);
            }
        ...
        //draw hexagon button function
        void DrawHexagonButton(Graphics g)
        {
            Color c1 = Color.FromArgb(color1Transparent, color1);
            Color c2 = Color.FromArgb(color2Transparent, color2);
            ...
            Point[] points = new Point[] {
             new Point(this.Width / 2, 2), 
             new Point(this.Width-10,this.Height/2-30),
             new Point(this.Width-10,this.Height-30),
             new Point(this.Width/2,this.Height-10),
             new Point(10,this.Height-30),
             new Point(10,this.Height/2-30)
            };
        ...
        //draw leftarrow button function
        void DrawLeftArrowButton(Graphics g)
        {
            Color c1 = Color.FromArgb(color1Transparent, color1);
            Color c2 = Color.FromArgb(color2Transparent, color2);
            ...
            Point[] points = new Point[] {
             ...
             new Point(this.Width/2,2),
             new Point(this.Width/2,this.Height/2-(this.Height/2-30)),
             new Point(this.Width-10,this.Height/2-(this.Height/2-30)),
             new Point(this.Width-10,this.Height/2+(this.Height/2-30)),
             new Point(this.Width/2,this.Height/2+(this.Height/2-30)),
             new Point(this.Width/2,this.Height-10),
             new Point(2,this.Height/2)
            ...
            for (int i = 0; i < borderWidth; i++)
            {
                g.DrawLine(new Pen(buttonborder_2), 2 + i, this.Height / 2 + i, this.Width / 2 + i, 2 + i);
                g.DrawLine(new Pen(buttonborder_2), this.Width / 2 + i, 2, this.Width / 2 + i, this.Height / 2 - (this.Height / 2 - 30));
                g.DrawLine(new Pen(buttonborder_2), this.Width / 2, this.Height / 2 - (this.Height / 2 - 30) - i, this.Width - 10, this.Height / 2 - (this.Height / 2 - 30) - i);
                g.DrawLine(new Pen(buttonborder_1), this.Width - 10 + i, this.Height / 2 - (this.Height / 2 - 30), this.Width - 10 + i, this.Height / 2 + (this.Height / 2 - 30));
                g.DrawLine(new Pen(buttonborder_1), this.Width - 10, this.Height / 2 + (this.Height / 2 - 30) + i, this.Width / 2, this.Height / 2 + (this.Height / 2 - 30) + i);
                g.DrawLine(new Pen(buttonborder_1), this.Width / 2 + i, this.Height / 2 + (this.Height / 2 - 30), this.Width / 2 + i, this.Height - 10);
                g.DrawLine(new Pen(buttonborder_1), this.Width / 2 + i, this.Height - 10 - i, 2 + i, this.Height / 2 - i + 2);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (buttonShape)
            {
                ...
                case ButtonsShapes.Triangle:
                    this.DrawTriangularButton(e.Graphics);
                    break;

                case ButtonsShapes.Diamond:
                    this.DrawDiamondButton(e.Graphics);
                    break;

                case ButtonsShapes.Pentagon:
                    this.DrawPentagonButton(e.Graphics);
                    break;

                case ButtonsShapes.Hexagon:
                    this.DrawHexagonButton(e.Graphics);
                    break;

                case ButtonsShapes.LeftArrow:
                    this.DrawLeftArrowButton(e.Graphics);
                    break;
